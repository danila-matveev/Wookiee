...
| Канал | Стоимость | % выручки | На единицу | Δ ₽ | Δ % |
|---|---|---|---|---|---|
| WB | X₽ | X% | X₽ | Δ₽ | **±X%** |
| OZON | X₽ | X% | X₽ | Δ₽ | **±X%** |
| **Итого** | **X₽** | **X%** | — | — | — |
...
| Модель | WB | OZON | МС (офис) | Оборач. (дн.) | Статус | Эффект |
|---|---|---|---|---|---|---|
| model | X шт | X шт | X шт | X дн. | ⚠️ Дефицит | −X₽ потери |
| model | X шт | X шт | X шт | X дн. | Перезапас | X₽ заморожено |
