---
name: cloudflare-pub
description: "Publish any content to Cloudflare Pages — replaces Telegraph. Use when user asks to publish, deploy, host, share online, make a public link, telegraph, телеграф, опубликуй, publish, поделись ссылкой, сделай публичную ссылку, share as a link, put this online. Works with .docx, .md, .txt, .html and generated content. This is the DEFAULT publishing skill — use instead of telegraph-legacy."
license: MIT
...
metadata:
  ...
  version: 1.1.0
  category: publishing
  tags: [cloudflare, pages, deploy, hosting, telegraph, publish]
---
