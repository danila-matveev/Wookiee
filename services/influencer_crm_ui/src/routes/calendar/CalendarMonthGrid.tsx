...
/**
 * Build a 6×7 grid of dates for the month containing `monthDate`.
 * First column is Monday (ISO week). Returns 42 cells: prev-month tail,
 * current month, next-month head — exactly like the prototype.
 */
...
/** Channels supported by `PlatformPill`; 'rutube' has no pill style → fall back to 'youtube'. */
