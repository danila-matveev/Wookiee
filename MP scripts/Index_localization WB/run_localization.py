...
from wb_sheets_sync.config import CABINET_IP, CABINET_OOO, MOYSKLAD_TOKEN
...
from wb_localization_mappings import (
    WAREHOUSE_TO_FD,
    SKIP_WAREHOUSES,
    get_warehouse_fd,
    get_delivery_fd,
...
def parse_args():
    ...
    parser.add_argument(
        '--sku-db', default=str(PROJECT_ROOT / 'wookiee_sku_database' / 'Спецификации.xlsx'),
