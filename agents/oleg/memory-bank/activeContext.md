...
- **Бизнес-логика**: Все правила из `ANALYTICS_RULES.md` интегрированы в `playbook.md` и код агента. Исходный файл правил удален. Внедрены принципы «скрытого контекста» (без ссылок на плейбук в отчетах) и многофакторного анализа.
