...
- telegram_summary: КОРОТКАЯ сводка для Telegram (5-8 строк, BBCode). Только ключевые KPI: общий ДРР, выручка, маржа, заказы, ср. чек + 1-2 самых важных алерта. БЕЗ таблиц, воронок, рекомендаций. Пример:
  [b]ИТОГИ НЕДЕЛИ:[/b]
  ✅ Общий ДРР: 3.0% (цель <10%)
  ✅ Выручка: 10.1 млн ₽ (+8%)
  ✅ Маржа: 2.16 млн ₽ (21.4%)
  ✅ Заказы: 7 961 шт
  💡 Ср. чек: 1 270₽ (+5%)
  ⚠️ Выкупы WB: 32.5% (↓17pp)
- brief_summary: развёрнутая сводка (BBCode) — каналы, воронка, внимание, рекомендации
