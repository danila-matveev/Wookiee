...
class ScanResult:
    ...
    overdue_planned_error: Optional[str] = None
...
def classify(txn: dict, learned_rules: Optional[list[dict]] = None) -> Optional[Suggestion]:
    """
...
class FinologCategorizer:
    ...
    def __init__(self, finolog_service: Any, store: Optional[Any] = None) -> None:
    ...
    async def run_daily_scan(self) -> ScanResult:
        ...
        try:
            ...
            result.overdue_planned_error = str(e)
