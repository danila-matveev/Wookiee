...
from agents.lyudmila.services.user_cache import UserCache
from agents.lyudmila.services.db_service import DBService
from agents.lyudmila.services.auth_service import AuthService
from agents.lyudmila.services.lyuda_ai import LyudaAI
from agents.lyudmila.services.digest_service import DigestService
from agents.lyudmila.services.scheduler_service import LyudmilaScheduler
from agents.lyudmila.services.supabase_service import LyudmilaSupabase
from agents.lyudmila.services.sync_service import BitrixSyncService
from agents.lyudmila.services.weekly_digest_service import WeeklyDigestService
from agents.lyudmila.services.context_service import ContextService

from agents.lyudmila.handlers import auth, menu, task_creation, meeting_creation, digest, free_input
    ...
    def _setup_scheduler(self) -> None:
        ...
        async def send_digest(telegram_id: int):
            ...
            try:
                ...
                from agents.lyudmila.handlers.common import menu_only_keyboard
