...
class SchemaManager:
    ...
    def __init__(self, proposals_dir: Path | None = None):
        from agents.ibrahim.config import SCHEMA_PROPOSALS_DIR
        self.proposals_dir = proposals_dir or SCHEMA_PROPOSALS_DIR
    ...
    def compare_schemas(self) -> dict:
        ...
        Returns:
            dict with 'managed' and 'source' schema text.
        """
        result = {}
