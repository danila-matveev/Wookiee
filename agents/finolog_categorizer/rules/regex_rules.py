...
from .description_rules import (
    CAT_FOT_MKT, CAT_FOT_WAREHOUSE, CAT_FOT_MGMT, CAT_CONTENT_CREATORS,
    CAT_BLOGGERS, CAT_SELFBUYS, CAT_ADS_WB, CAT_ADS_OZON, CAT_ADS_EXTERNAL,
    ...
    CAT_GIFTS_BLOGGERS, CAT_DELIVERY_BLOGGERS, CAT_STAFF_OTHER,
