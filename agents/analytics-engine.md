...
- **Внутренние:** `wookiee_sku_database/` (статусы артикулов через Supabase)
...
- Справочник БД: [`database_docs/DATABASE_REFERENCE.md`](../database_docs/DATABASE_REFERENCE.md)
- Качество данных: [`database_docs/DATA_QUALITY_NOTES.md`](../database_docs/DATA_QUALITY_NOTES.md)
