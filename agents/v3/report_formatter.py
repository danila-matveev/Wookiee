...
COMPILER_FORMAT_INSTRUCTIONS = (
    ...
    '- "warnings": [string]\n'
    "\nПример detailed_report (только формат):\n"
    '"# Финансовый отчёт за 19 марта 2026\\n\\n'
    "## ▶ 0. Паспорт отчёта\\n"
    "| Параметр | Значение |\\n|---|---|\\n| Период | 19 марта 2026 |\\n\\n"
    "## ▶ 1. Ключевые выводы\\n"
    "| ₽ эффект | Что произошло → Гипотеза → Действие |\\n|---|---|\\n"
    "| -34 600 | WB: маржа упала на 14.1% → рост рекламы → пересмотреть |\\n\\n"
    "## ▶ 3. Ключевые изменения (Бренд)\\n"
    "| Метрика | Текущий | Прошлый | Δ абс. | Δ % |\\n|---|---|---|---|---|\\n"
    '| Маржинальная прибыль | 255 202 ₽ | 279 782 ₽ | -24 580 ₽ | -8.8 |\\n..."\n'
