...
from agents.lyudmila.handlers.menu import create_main_menu_keyboard
...
async def handle_free_message(
    ...
    if intent == "task":
        ...
        from agents.lyudmila.handlers.task_creation import process_task_description
        ...
        from agents.lyudmila.handlers.meeting_creation import process_meeting_description
