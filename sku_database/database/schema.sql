...
CREATE TABLE modeli_osnova (
    ...
    tip_kollekcii VARCHAR(30) CHECK (tip_kollekcii IN ('Трикотажное белье', 'Бесшовное белье Jelly', 'Бесшовное белье Audrey')),
...
COMMENT ON COLUMN modeli_osnova.tip_kollekcii IS 'Тип коллекции (Трикотажное белье, Бесшовное белье Jelly, Бесшовное белье Audrey)';
