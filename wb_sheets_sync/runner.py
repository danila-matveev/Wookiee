...
Usage:
    python -m wb_sheets_sync.runner <name|all>
    python -m wb_sheets_sync.runner --list
    python -m wb_sheets_sync.runner --test wb_stocks

Examples:
    python -m wb_sheets_sync.runner wb_stocks
    python -m wb_sheets_sync.runner all
    python -m wb_sheets_sync.runner search_analytics --start 01.01.2026 --end 07.01.2026
"""
...
from wb_sheets_sync.config import LOG_LEVEL, TEST_MODE
...
SYNC_REGISTRY: dict[str, dict] = {
    "wb_stocks": {
        "module": "wb_sheets_sync.sync.sync_wb_stocks",
        "sheet": "WB остатки",
        "description": "WB warehouse remains (async report)",
    },
    "wb_prices": {
        "module": "wb_sheets_sync.sync.sync_wb_prices",
        "sheet": "WB Цены",
        "description": "WB prices (paginated)",
    },
    "moysklad": {
        "module": "wb_sheets_sync.sync.sync_moysklad",
        "sheet": "МойСклад_АПИ",
        "description": "MoySklad assortment + additional data",
    },
    "ozon": {
        "module": "wb_sheets_sync.sync.sync_ozon_stocks_prices",
        "sheet": "Ozon остатки и цены",
        "description": "OZON stocks & prices (report-based)",
    },
    "wb_feedbacks": {
        "module": "wb_sheets_sync.sync.sync_wb_feedbacks",
        "sheet": "Отзывы ООО / Отзывы ИП",
        "description": "WB feedbacks rating aggregation",
    },
    "wb_bundles": {
        "module": "wb_sheets_sync.sync.sync_wb_bundles",
        "sheet": "Склейки WB",
        "description": "WB bundle prices (S-V columns)",
    },
    "ozon_bundles": {
        "module": "wb_sheets_sync.sync.sync_ozon_bundles",
        "sheet": "Склейки Озон",
        "description": "OZON bundle prices & stock (R, S, V columns)",
    },
    "search_analytics": {
        "module": "wb_sheets_sync.sync.sync_search_analytics",
...
def main():
    ...
    if args.list:
        ...
        print(f"\nUsage: python -m wb_sheets_sync.runner <name|all>")
        return
