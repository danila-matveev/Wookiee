...
SEED_TOOLS = [
    ...
    ("/bitrix-analytics", "Пульс команды WOOKIEE", "skill", "team", "active", "v2",
     "Еженедельный аналитический отчёт из 6 источников: задачи, групповые чаты (включая обсуждения в задачах), календарь сотрудников, лички CEO, планерки из Notion. Privacy-фильтр (тест планерки), сегментация по слоям (Операционный: Данила+Полина+Лиза). Публикация в Notion.", "/bitrix-analytics", "danila"),
