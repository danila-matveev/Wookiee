...
import type { ResponseTimePoint } from "@/types/comms"

interface CommsDashboardChartProps {
...
export function CommsDashboardChart({ data, className, periodLabel = "за 14 дней" }: CommsDashboardChartProps) {
  return (
    <div className={cn("bg-card border border-border rounded-[10px] p-4", className)}>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold">Скорость ответов {periodLabel}</h3>
